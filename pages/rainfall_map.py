...
def render_navbar():
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-brand">🌧️ SmartSDGTunisia</div>
        </div>
    </nav>
...
with col1:
    ...
    <div class="card" style="border-left: 4px solid {COLORS['accent']}; text-align:center">
        ...
        <h1 style="color:{COLORS['accent']}">{avg_rainfall:.1f} mm</h1>
...
with col2:
    ...
    <div class="card" style="border-left: 4px solid {COLORS['secondary']}; text-align:center">
        <h3>⬆️ Maximum</h3>
        <h1 style="color:{COLORS['secondary']}">{max_rainfall:.1f} mm</h1>
...
with col3:
    ...
    <div class="card" style="border-left: 4px solid {COLORS['orange']}; text-align:center">
        <h3>⬇️ Minimum</h3>
        <h1 style="color:{COLORS['orange']}">{min_rainfall:.1f} mm</h1>
...
with col4:
    ...
    <div class="card" style="border-left: 4px solid {COLORS['primary']}; text-align:center">
        <h3>📍 Stations</h3>
        <h1 style="color:{COLORS['primary']}">{station_count}</h1>
        ...
        if show_stats:
            ...
            with col_kpi1:
                ...
                <div class="local-kpi-card">
                    ...
                    <div class="local-kpi-value" style="color:{COLORS['accent']}">{station_data['Valeur']:.1f} mm</div>
            ...
            with col_kpi2:
                ...
                <div class="local-kpi-card">
                    ...
                    <div class="local-kpi-value" style="color:{COLORS['secondary']}; font-size:1.2rem;">
            ...
            <div class="local-kpi-card" style="text-align:center; background: rgba(30,108,65,0.03);">
                ...
                <div style="display:inline-block; margin:0 15px;">
                    ...
                    <div style="font-size:1.5rem; font-weight:700; color:{COLORS['primary']}">#{rank}</div>
                </div>
            </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            if predictions is not None:
                ...
                with col1:
                    ...
                    <div class="prediction-card">
                        ...
                        <div class="prediction-value" style="color:{COLORS['accent']}">{mse:.2f}</div>
                ...
                with col2:
                    ...
                    <div class="prediction-card">
                        ...
                        <div class="prediction-value" style="color:{COLORS['secondary']}">{mae:.2f} mm</div>
                ...
                if alert_months:
                    st.markdown(f"""
                    <div style="background-color: rgba(242,125,22,0.1); border-left: 4px solid {COLORS['orange']}; 
                                padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                        <h3 style="color: {COLORS['orange']}; margin-top: 0;">
                    ...
                    st.dataframe(
                        alert_df.style.applymap(
                            lambda x: f"color: {COLORS['orange']}; font-weight: bold",
                            subset=["Dépassement"]
                        ),
                        hide_index=True,
                        use_container_width=True
